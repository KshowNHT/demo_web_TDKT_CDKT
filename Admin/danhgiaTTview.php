    ...
    <?php foreach ($data as $item): ?>
        <tr>
            ...
            <?php if(isset($_SESSION['TenTk']) && $_SESSION['VaiTro'] === 'Quản Trị'): ?> 
                <td>
                    <button class="btn btn-custom btn-custom-primary" onclick="handleAction('danhgiaTTsua', '<?php echo $item->MaDGTT; ?>')">Sửa Đánh Giá</button>
                </td>
            <?php endif; ?>
        </tr>
    <?php endforeach; ?>
    ...
    try {
        ...
        data.forEach(item => {
            ...
            if (validDanhGia.includes(item.DanhGia)) {
                ...
                buttonSua.onclick = () => handleAction('danhgiaTTsua', item.MaDGTT);
