...
<div class="container">
    <form method="post">
        ...
        <div class="form-group flex-container">
            <label><input type="checkbox" name="hoan_thanh_nhiem_vu"> Hoàn thành nhiệm vụ</label>
            <label><input type="checkbox" name="ca_nhan_70_phan_tram"> Cá nhân 70% đạt Danh Hiệu LĐTT</label>
            <label><input type="checkbox" name="ky_luat"> Có Cá Nhân Bị Kỷ luật</label>
            <label><input type="checkbox" name="dong_y"> Có 2/3 Thành Viên HĐ Đồng ý</label>
        </div>
