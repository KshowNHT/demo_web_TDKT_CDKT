...
<form method="post">
    ...
    <div class="form-group">
        <label>Hoàn thành tốt Nhiệm Vụ: <input type="checkbox" name="hoan_thanh_tot_nhiem_vu"></label><br>
        <label>Hoàn thành xuất sắc: <input type="checkbox" name="hoan_thanh_xuat_sac"></label><br>
        <label>Có 70% cá nhân đạt danh hiệu LĐTT : <input type="checkbox" name="ca_nhan_70_phan_tram"></label><br>
        <label>Có 100% cá nhân trong tập thể hoàn thành nhiệm vụ : <input type="checkbox" name="ca_nhan_100_phan_tram"></label><br>
        <label>Có cá nhân đạt danh hiệu CSTĐCS : <input type="checkbox" name="ca_nhan_dat_cstdcs"></label><br>
        <label>Cá nhân 90%: <input type="checkbox" name="ca_nhan_90_phan_tram"></label><br>
        <label>Kỷ luật: <input type="checkbox" name="ky_luat"></label><br>
        <label>Đồng ý: <input type="checkbox" name="dong_y"></label><br>
